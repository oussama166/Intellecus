...
<body>
            ...
            <tbody>
              <?php foreach ($entreprises as $entreprise) : ?>
                <tr>
                  ...
                  <td><button type=" submit" name="Supp"><a href="../proc/etapes/etape2Admin.php?id=<?= $entreprise->ID?>"> Details</a></button></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
  ...
  function afficherEntre($conn)
  {
    ...
    $req = $conn->prepare("SELECT entreprise.Id_Entreprise as ID,entreprise.Nom_Entreprise as Nom FROM client ,entreprise WHERE client.Id_entreprise= entreprise.Id_Entreprise and client.Id_raison_social=2 and Flag=3 ");
    $req->execute();
