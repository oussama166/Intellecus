...
<head>
  ...
  <?php
    ...
    }else if (!idFlag6($_SESSION['Id_Client'], $conn)) {
...
<body>
  <div class="container">
    <div class="left-side">
        <div class="uper-left">
          <h1 class="pd-1 ml-1 txt-ctr">Fichier Techni OFPPT</h1>
        </div>
        <div class="body-left p-4">
          <ul class="list-unstyled multi-steps">
            <li id="progress-itms" class="is-active">
              <span class="title">Exuction de plan</span>
            </li>
            <li id="progress-itms" calss="">
              <span class="title">Modification de plan</span>
            </li>
          </ul>
        </div>
                    ...
                    <div class="body-right">
                        <div class="input-section p-5">
                            <div class="section">
                                ...
                                <br><br> 
                                <sub class="pd-4">*</sub><small class="pd-4 ">Fiche de présence</small>
                            </div>
                        </div>
                        <div class="input-section p-5">
                            <div class="section">
                                <input type="file" class="file" id="file" name="pdf1"   />
                                <br><br> 
                                <sub class="pd-4">*</sub><small class="pd-4">Fiche d' evaliation</small>
                            </div>
                        </div>
                        <div class="input-section p-5">
                            <div class="section">
                                <input type="file" class="file" id="file" name="pdf2"   />
                                <br><br> 
                                <sub class="pd-4">*</sub><small class="pd-4 ">Fiche d'evaluation synthetique</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="right-side">
                    ...
                    <div class="body-right">
                        <div class="input-section ">
                            <input type="file" class="file" name="pdf3" value=""   />
                            <br><br> 
                                <sub class="pd-4"></sub><small class="pd-4">Avis de modufication Ou annulation</small>
                        </div>
                    </div>
                    <div class="footer-right">
  ...
  <script>
    ...
    if (isset($_POST['Valider'])) {
        ...
        if (mkdir($curdir . "../../../Assest/C" . $Id_Client . "/D7", 0777)) {
        }

        $date =  htmlspecialchars(strip_tags($_POST['ladate']));

        $chemin = "../../../Assest/C" . $Id_Client . "/D7" . "/";
        ...
        $stmt = $conn->prepare("INSERT INTO dossier_technique_ofppt (Id_client,Fiche_Presence,Fiche_Evaluation_Individuelle,Fiche_Evaluation_Synthetique,Avis_de_modufication_ou_annulation) VALUES (?,?,?,?,?);");
